...
def train(deviceId):
    ...
    for i in range(1,10):
        for j in range(i+1,11):
            data11 = pd.read_csv(deviceId+"/train/pressure"+str(i)+".csv")
    ...
    for per in range(11,21):
        ...
        data2 = []
        for j in range(1,11):
            data11 = pd.read_csv(deviceId+"/train/pressure"+str(per)+".csv")
            data21 = pd.read_csv(deviceId+"/train/pressure"+str(j)+".csv")
            data1.append(data11)
            data2.append(data21)
    ...
    print(threshold)
    fileOpen = open(deviceId+"/pressureThreshold.txt","w+")
    ...
    for out1 in out:
        ...
        fileOpen.write("\n")
    fileOpen.close()
    fileOpen = open(deviceId+"/validPressure.txt","w+")
