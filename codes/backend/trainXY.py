...
def train(deviceId):
    ...
    for i in range(1,10):
        for j in range(i+1,11):
            data11 = pd.read_csv(deviceId+"/train/xy"+str(i)+".csv")
    ...
    for per in range(11,21):
        ...
        data2 = []
        for j in range(1,11):
            data11 = pd.read_csv(deviceId+"/train/xy"+str(per)+".csv")
            data21 = pd.read_csv(deviceId+"/train/xy"+str(j)+".csv")
            data1.append(data11)
            data2.append(data21)
    ...
    print(threshold)
    fileOpen = open(deviceId+"/xyThreshold.txt","w+")
    ...
    for out1 in out:
        ...
        fileOpen.write("\n")
    fileOpen.close()
    fileOpen = open(deviceId+"/validXY.txt","w+")
